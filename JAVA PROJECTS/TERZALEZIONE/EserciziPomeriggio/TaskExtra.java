...
public class TaskExtra {
    ...
    public static void main(String [] args){
        ...
        //creazione di uno scanner primordiale per scegliere l'operazione da eseguire
        Scanner in = new Scanner(System.in);
        System.out.println("scegli cosa esguire inserendo un numero da 1 a 3");
        
        //inserimento di un numero da 1 a 3 in base ai casi dello switch presenti nella parte sottostante
